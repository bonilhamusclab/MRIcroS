...
% inputs: ambient(0..1), diffuse(0..1), specular(0..1), specularExponent(0..inf), showEdges (0 or 1), backFaceLighting (0 or 1)
...
if (length(varargin) > 4), v.vprefs.showEdges = vIn(5); end;

...
v.hSimplifyMeshesMenu = uimenu('Parent',v.hFunctionMenu,'Label','Add tracks','HandleVisibility','callback','Callback', @Add_tracks_Callback);
...
function Add_tracks_Callback(obj, eventdata)
v=guidata(obj);

...
v.hAddNodesWithOptsMenu = uimenu('Parent',v.hFileMenu, 'Label','Add Nodes with options', 'HandleVisibility', 'callback',...
    'Callback', utils.curry(@gui.AddNodes_Callback, showOpts));
v.hCloseNodesMenu = uimenu('Parent',v.hFileMenu, 'Label','Close Nodes', 'HandleVisibility', 'callback',...
    'Callback', @gui.CloseNodes_Callback);
...
v.hCloseBrainNetEdgesMenu = uimenu('Parent',v.hFunctionMenu, 'Label', 'Close Connection Edges', 'HandleVisibility', 'callback', 'Callback', @gui.CloseEdges_Callback);
